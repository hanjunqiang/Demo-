...
#pragma mark -mrhan添加消息到_dataSource
...
#pragma mark - EM_MessageToolBarDelegate显示键盘的时候
...
//MoroTool
#pragma mark -mrhan点击加号出现的图片、相机、语音、视频、位置、文件对应的点击事件
...
#pragma mark - EM_ChatMessageCellDelegate点击头像出发的方法
...
#pragma mark -mrhan长按消息弹出菜单，菜单监听
...
#pragma mark - EMChatManagerChatDelegate将要发送消息
